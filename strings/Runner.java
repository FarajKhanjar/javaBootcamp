...
public class Runner {
    ...
    public static void menuText_2() {
        String word = getUserInputByMsg("Enter the word: ");        
    ...
    public static void menuText_3() {
        String sentence = getUserInputByMsg("Enter the sentence: ");
        String word = getUserInputByMsg("Enter the word: ");
    ...
    public static void menuText_5() {
        String sentence = getUserInputByMsg("Enter the sentence: ");
        String firstWord = getUserInputByMsg("Enter the target word: ");
        String secondWord = getUserInputByMsg("Enter the replacement word: ");
    ...
    public static void menuText_6() {
        String sentence = getUserInputByMsg("Enter the sentence: ");
        String letter = getUserInputByMsg("Enter the letter: ");
...
public static void main(String[] args) {
    	...
    	int selectionInput;
        do {        	
            selectionInput = Integer.parseInt(getUserInputByMsg("Enter you selection index: "));
